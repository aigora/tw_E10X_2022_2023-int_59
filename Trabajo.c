			...
			switch (OP)
			{
				...
				case 2:
				{
					...
					if (OP==2)
					{
						...
						for (i=0;i<num_meses;i++)//traduce la informacion dada por el usuario a el valor de la generacion de energÌa del mes escogido y almacena los datos de todos los meses en un unico vector 
						{
